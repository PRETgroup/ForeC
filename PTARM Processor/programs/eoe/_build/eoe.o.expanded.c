...
int main(void) {
 ...
 switch (localScheduler.hwThreadId) {
  case (0): // Hardware thread 0.
     asm volatile("cdp p13, 1, cr0, cr7, cr0, 1"); ptarmUartOutputStr("EOE example.\n\n"); asm volatile("cdp p13, 1, cr0, cr7, cr0, 0");
...
eoeHandler: {
 // "Task: xxx preempted."
 asm volatile("cdp p13, 1, cr0, cr7, cr0, 1");
 ptarmUartOutputStr("Preempted task: "); ptarmUartOutputStr(localScheduler.currentTask->name); ptarmUartOutputStr(".\n");
 asm volatile("cdp p13, 1, cr0, cr7, cr0, 0");
...
# 147 "eoe.c"
 ...
 asm volatile("cdp p13, 1, cr0, cr7, cr0, 1"); ptarmUartOutputStr("!! Schedulering error: Oops!\n"); asm volatile("cdp p13, 1, cr0, cr7, cr0, 0");
}
