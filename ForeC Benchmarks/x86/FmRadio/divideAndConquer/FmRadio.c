...
mainParCore0: {
	...
	while (fread(read_buffer__main_0_0, sizeof(float), 16, input_file__global_0_0) == 16) {
		...
		ntaps_filter_ffd_1__thread.nextThread = &ntaps_filter_ffd_2__thread;
		ntaps_filter_ffd_2__thread.prevThread = &ntaps_filter_ffd_1__thread;
		...
		ntaps_filter_ffd_3__thread.nextThread = &mainReactionEndMaster0;
		mainReactionEndMaster0.prevThread = &ntaps_filter_ffd_3__thread;
