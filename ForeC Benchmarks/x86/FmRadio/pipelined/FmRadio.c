...
Shared_fm_qd_value__global_0_0 fm_qd_value__global_0_0 = {.value = 0.0, .status = FOREC_SHARED_UNMODIFIED};
...
typedef struct {
	/* shared */ float *value;
	int status;
} Shared_ffd_buffer__global_0_0;
Shared_ffd_buffer__global_0_0 ffd_buffer__global_0_0 = {.value = ffd_buffer_array__global_0_0, .status = FOREC_SHARED_UNMODIFIED};
typedef struct {
	/* shared */ float value;
	int status;
...
Shared_fm_qd_buffer__global_0_0 fm_qd_buffer__global_0_0_copy_ntaps_filter_ffd_4 = {.status = FOREC_SHARED_UNMODIFIED};
...
Shared_ffd_buffer__global_0_0 ffd_buffer__global_0_0_copy_ntaps_filter_ffd_5 = {.status = FOREC_SHARED_UNMODIFIED};
...
mainParCore0: {
	...
	output_file__global_0_0.value = fopen("FmRadio.raw", "w");
	if (output_file__global_0_0.value == NULL__global_0_0) {
		printf("Cannot open output file FmRadio.raw\n");
		exit(1);
	} else {
		// if1
	}
	text_file__global_0_0.value = fopen("FmRadio.txt", "w");
	if (text_file__global_0_0.value == NULL__global_0_0) {
	...
	ntaps_filter_ffd_init0__thread.nextThread = &ntaps_filter_ffd_init4__thread;
	ntaps_filter_ffd_init4__thread.prevThread = &ntaps_filter_ffd_init0__thread;
	mainReactionEndMaster0.programCounter = &&mainReactionEndMaster0;
	ntaps_filter_ffd_init4__thread.nextThread = &mainReactionEndMaster0;
	mainReactionEndMaster0.prevThread = &ntaps_filter_ffd_init4__thread;
	...
	while (fread(read_buffer__main_0_0, sizeof(float), 16, input_file__global_0_0) == 16) {
		for (i__main_1_3 = 0; i__main_1_3 < 8; i__main_1_3++) {
			fm_quad_demod(&fm_qd_conf__main_0_0, read_buffer__main_0_0[i__main_1_3*2], read_buffer__main_0_0[i__main_1_3*2 + 1], &fm_qd_value__global_0_0.value);
			fm_qd_buffer__global_0_0.value[i__main_1_3] = fm_qd_value__global_0_0.value;
			...
			multiply_square(resume_1__global_0_0.value, resume_2__global_0_0.value, &ffd_value__global_0_0);
			ffd_buffer__global_0_0.value[i__main_1_3] = ffd_value__global_0_0;
		...
		mainReactionStartMaster0.nextThread = &ntaps_filter_ffd_4__thread;
		ntaps_filter_ffd_4__thread.prevThread = &mainReactionStartMaster0;
		mainReactionEndMaster0.programCounter = &&mainReactionEndMaster0;
		ntaps_filter_ffd_4__thread.nextThread = &mainReactionEndMaster0;
		mainReactionEndMaster0.prevThread = &ntaps_filter_ffd_4__thread;
	...
	fclose(output_file__global_0_0.value);
	fclose(text_file__global_0_0.value);
...
mainParCore1: {
	...
	if (parId == 0) {
		...
		mainReactionStartSlave1.nextThread = &ntaps_filter_ffd_init1__thread;
		ntaps_filter_ffd_init1__thread.prevThread = &mainReactionStartSlave1;
		ntaps_filter_ffd_init5__thread.programCounter = &&ntaps_filter_ffd_init5__thread;
		ntaps_filter_ffd_init1__thread.nextThread = &ntaps_filter_ffd_init5__thread;
		ntaps_filter_ffd_init5__thread.prevThread = &ntaps_filter_ffd_init1__thread;
		mainReactionEndSlave1.programCounter = &&mainReactionEndSlave1;
		ntaps_filter_ffd_init5__thread.nextThread = &mainReactionEndSlave1;
		mainReactionEndSlave1.prevThread = &ntaps_filter_ffd_init5__thread;
		...
		// Go to the first thread.
		goto ntaps_filter_ffd_init1__thread;
		asm("# par0 end");
	} else if (parId == 1) {
		asm("# par1 start");
		// Link the threads and handlers together.
		...
		mainReactionStartSlave1.nextThread = &ntaps_filter_ffd_5__thread;
		ntaps_filter_ffd_5__thread.prevThread = &mainReactionStartSlave1;
		mainReactionEndSlave1.programCounter = &&mainReactionEndSlave1;
		ntaps_filter_ffd_5__thread.nextThread = &mainReactionEndSlave1;
		mainReactionEndSlave1.prevThread = &ntaps_filter_ffd_5__thread;
...
mainParCore2: {
	...
	if (parId == 0) {
		...
		mainReactionStartSlave2.nextThread = &ntaps_filter_ffd_init2__thread;
		ntaps_filter_ffd_init2__thread.prevThread = &mainReactionStartSlave2;
		mainReactionEndSlave2.programCounter = &&mainReactionEndSlave2;
		ntaps_filter_ffd_init2__thread.nextThread = &mainReactionEndSlave2;
		mainReactionEndSlave2.prevThread = &ntaps_filter_ffd_init2__thread;
...
mainParCore3: {
	...
	if (parId == 0) {
		...
		mainReactionStartSlave3.nextThread = &ntaps_filter_ffd_init3__thread;
		ntaps_filter_ffd_init3__thread.prevThread = &mainReactionStartSlave3;
		mainReactionEndSlave3.programCounter = &&mainReactionEndSlave3;
		ntaps_filter_ffd_init3__thread.nextThread = &mainReactionEndSlave3;
		mainReactionEndSlave3.prevThread = &ntaps_filter_ffd_init3__thread;
...
*=============================================================*/
	...
	*-------------------------------------------------------------*/
	...
	ntaps_filter_ffd_0__thread: {
		...
		fm_qd_value__global_0_0_copy_ntaps_filter_ffd_0_local.value = fm_qd_value__global_0_0.value;
		...
		band_12__global_0_0_copy_ntaps_filter_ffd_0_local.value = band_12__global_0_0.value;
		...
		resume_1__global_0_0_copy_ntaps_filter_ffd_0_local = resume_1__global_0_0;
	...
	*-------------------------------------------------------------*/
	...
	ntaps_filter_ffd_1__thread: {
		// Initialise the local copies of shared variables.
		fm_qd_value__global_0_0_copy_ntaps_filter_ffd_1_local.value = fm_qd_value__global_0_0.value;
	...
	*-------------------------------------------------------------*/
	...
	ntaps_filter_ffd_2__thread: {
		// Initialise the local copies of shared variables.
		band_22__global_0_0_copy_ntaps_filter_ffd_2_local.value = band_22__global_0_0.value;
		band_22__global_0_0_copy_ntaps_filter_ffd_2_local.status = FOREC_SHARED_UNMODIFIED;
		fm_qd_value__global_0_0_copy_ntaps_filter_ffd_2_local.value = fm_qd_value__global_0_0.value;
		...
		resume_2__global_0_0_copy_ntaps_filter_ffd_2_local = resume_2__global_0_0;
	...
	*-------------------------------------------------------------*/
	...
	ntaps_filter_ffd_3__thread: {
		...
		fm_qd_value__global_0_0_copy_ntaps_filter_ffd_3_local.value = fm_qd_value__global_0_0.value;
	...
	*-------------------------------------------------------------*/
	...
	Shared_fm_qd_buffer__global_0_0 fm_qd_buffer__global_0_0_copy_ntaps_filter_ffd_4_local;
	...
	ntaps_filter_ffd_4__thread: {
		// Initialise the local copies of shared variables.
		output_file__global_0_0_copy_ntaps_filter_ffd_4_local.value = output_file__global_0_0.value;
		output_file__global_0_0_copy_ntaps_filter_ffd_4_local.status = FOREC_SHARED_UNMODIFIED;
		output1__global_0_0_copy_ntaps_filter_ffd_4_local.value = output1__global_0_0.value;
		output1__global_0_0_copy_ntaps_filter_ffd_4_local.status = FOREC_SHARED_UNMODIFIED;
		band_3__global_0_0_copy_ntaps_filter_ffd_4_local.value = band_3__global_0_0.value;
		band_3__global_0_0_copy_ntaps_filter_ffd_4_local.status = FOREC_SHARED_UNMODIFIED;
		fm_qd_buffer__global_0_0_copy_ntaps_filter_ffd_4_local.value = fm_qd_buffer__global_0_0.value;
		...
		output_short_1__global_0_0_copy_ntaps_filter_ffd_4_local.value = output_short_1__global_0_0.value;
		...
		output2__global_0_0_copy_ntaps_filter_ffd_4_local = output2__global_0_0;
		...
		output_short_0__global_0_0.value = dac_cast_trunc_and_normalize_to_short(output1__global_0_0_copy_ntaps_filter_ffd_4_local.value);
		...
		output_short__ntaps_filter_ffd_4_0_0[0] = output_short_0__global_0_0.value;
	...
	*-------------------------------------------------------------*/
	...
	Shared_ffd_buffer__global_0_0 ffd_buffer__global_0_0_copy_ntaps_filter_ffd_5_local;
	...
	ntaps_filter_ffd_5__thread: {
		// Initialise the local copies of shared variables.
		text_file__global_0_0_copy_ntaps_filter_ffd_5_local.value = text_file__global_0_0.value;
		text_file__global_0_0_copy_ntaps_filter_ffd_5_local.status = FOREC_SHARED_UNMODIFIED;
		ffd_buffer__global_0_0_copy_ntaps_filter_ffd_5_local.value = ffd_buffer__global_0_0.value;
		ffd_buffer__global_0_0_copy_ntaps_filter_ffd_5_local.status = FOREC_SHARED_UNMODIFIED;
		output1__global_0_0_copy_ntaps_filter_ffd_5_local.value = output1__global_0_0.value;
		...
		output2__global_0_0_copy_ntaps_filter_ffd_5_local.value = output2__global_0_0.value;
		...
		band_3__global_0_0_copy_ntaps_filter_ffd_5_local = band_3__global_0_0;
		output2__global_0_0_copy_ntaps_filter_ffd_5_local = output2__global_0_0;
		output_short_1__global_0_0_copy_ntaps_filter_ffd_5_local = output_short_1__global_0_0;
	...
	*-------------------------------------------------------------*/
	...
	ntaps_filter_ffd_init0__thread: {
		...
		ntaps_filter_ffd_init(&lp_11_conf__global_0_0, 53000, 4000, 1, 1, input_rate__global_0_0.value, WIN_HANNING__ntaps_filter_ffd_init0_0_0);
	...
	*-------------------------------------------------------------*/
	...
	ntaps_filter_ffd_init1__thread: {
		...
		ntaps_filter_ffd_init(&lp_12_conf__global_0_0, 23000, 4000, 1, 1, input_rate__global_0_0.value, WIN_HANNING__ntaps_filter_ffd_init1_0_0);
	...
	*-------------------------------------------------------------*/
	...
	ntaps_filter_ffd_init2__thread: {
		...
		ntaps_filter_ffd_init(&lp_21_conf__global_0_0, 21000, 2000, 1, 1, input_rate__global_0_0.value, WIN_HANNING__ntaps_filter_ffd_init2_0_0);
	...
	*-------------------------------------------------------------*/
	...
	ntaps_filter_ffd_init3__thread: {
		...
		ntaps_filter_ffd_init(&lp_22_conf__global_0_0, 17000, 2000, 1, 1, input_rate__global_0_0.value, WIN_HANNING__ntaps_filter_ffd_init3_0_0);
	...
	*-------------------------------------------------------------*/
	...
	ntaps_filter_ffd_init4__thread: {
		...
		ntaps_filter_ffd_init(&lp_2_conf__global_0_0, 15000, 4000, 0.5, inout_ratio__global_0_0.value, input_rate__global_0_0.value, WIN_HANNING__ntaps_filter_ffd_init4_0_0);
	...
	*-------------------------------------------------------------*/
	...
	ntaps_filter_ffd_init5__thread: {
		...
		ntaps_filter_ffd_init(&lp_3_conf__global_0_0, 15000, 4000, 1.0, inout_ratio__global_0_0.value, input_rate__global_0_0.value, WIN_HANNING__ntaps_filter_ffd_init5_0_0);
