...
static const int IN_COUNT = 50;

static const int HSIZE = 257;		/* 95% occupancy */
...
//#define PBITS	16
//#define BITS 16
//static const int HSIZE = 257;		/* 95% occupancy was 69001 */
...
static const int BLOCK_MASK = 0x80;
...
int clear_flg = 0;
long int ratio = 0;
static const int CHECK_GAP = 10000;	/* ratio check interval */
count_int checkpoint = CHECK_GAP;
/*
 * the next two codes should not be changed lightly, as they must not
 * lie within the contiguous general code space.
 */
static const int FIRST = 257;	/* first free entry */
static const int CLEAR = 256;	/* table clear output code */
...
void compress(void)
{
	...
	nomatch:
		...
		if ( free_ent < maxmaxcode ) {
			codetab[i] = free_ent++;	        /* apsim_unknown codetab */
			htab[i] = fcode;			/* apsim_unknown htab */
