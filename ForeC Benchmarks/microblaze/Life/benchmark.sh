...
then
	...
	count=01
	echo $name $count
	elfName=${name}_timed.$count
	forecc -d1 -t69797 $name.forec $name.$count.foreh >> forecc.out
	mb-gcc -E -CC $name.c -o ${name}_expanded.c -I"${FOREC_ANALYSER_PATH}microblaze/include/" -I"${FOREC_ANALYSER_PATH}microblaze/drivers/counter_dfsl_v1_00_a/src/" -I"${FOREC_ANALYSER_PATH}microblaze/drivers/forec_mutex_v1_00_a/src/"
	mb-gcc -O0 -g ${name}_expanded.c -o $elfName.elf -mno-xl-soft-mul -mhard-float -mxl-float-convert -mxl-float-sqrt -mno-xl-soft-div -mcpu=v8.00.b -T forec_linker_script.ld -L"${FOREC_ANALYSER_PATH}microblaze/lib/"
	...
	echo $name $count
	elfName=${name}_timed.$count
	forecc -d1 -t44481 $name.forec $name.$count.foreh >> forecc.out
	mb-gcc -E -CC $name.c -o ${name}_expanded.c -I"${FOREC_ANALYSER_PATH}microblaze/include/" -I"${FOREC_ANALYSER_PATH}microblaze/drivers/counter_dfsl_v1_00_a/src/" -I"${FOREC_ANALYSER_PATH}microblaze/drivers/forec_mutex_v1_00_a/src/"
	mb-gcc -O0 -g ${name}_expanded.c -o $elfName.elf -mno-xl-soft-mul -mhard-float -mxl-float-convert -mxl-float-sqrt -mno-xl-soft-div -mcpu=v8.00.b -T forec_linker_script.ld -L"${FOREC_ANALYSER_PATH}microblaze/lib/"
	...
	echo $name $count
	elfName=${name}_timed.$count
	forecc -d1 -t40771 $name.forec $name.$count.foreh >> forecc.out
	mb-gcc -E -CC $name.c -o ${name}_expanded.c -I"${FOREC_ANALYSER_PATH}microblaze/include/" -I"${FOREC_ANALYSER_PATH}microblaze/drivers/counter_dfsl_v1_00_a/src/" -I"${FOREC_ANALYSER_PATH}microblaze/drivers/forec_mutex_v1_00_a/src/"
	mb-gcc -O0 -g ${name}_expanded.c -o $elfName.elf -mno-xl-soft-mul -mhard-float -mxl-float-convert -mxl-float-sqrt -mno-xl-soft-div -mcpu=v8.00.b -T forec_linker_script.ld -L"${FOREC_ANALYSER_PATH}microblaze/lib/"
	...
	echo $name $count
	elfName=${name}_timed.$count
	forecc -d1 -t33461 $name.forec $name.$count.foreh >> forecc.out
	mb-gcc -E -CC $name.c -o ${name}_expanded.c -I"${FOREC_ANALYSER_PATH}microblaze/include/" -I"${FOREC_ANALYSER_PATH}microblaze/drivers/counter_dfsl_v1_00_a/src/" -I"${FOREC_ANALYSER_PATH}microblaze/drivers/forec_mutex_v1_00_a/src/"
	mb-gcc -O0 -g ${name}_expanded.c -o $elfName.elf -mno-xl-soft-mul -mhard-float -mxl-float-convert -mxl-float-sqrt -mno-xl-soft-div -mcpu=v8.00.b -T forec_linker_script.ld -L"${FOREC_ANALYSER_PATH}microblaze/lib/"
	...
	echo $name $count
	elfName=${name}_timed.$count
	forecc -d1 -t36626 $name.forec $name.$count.foreh >> forecc.out
	mb-gcc -E -CC $name.c -o ${name}_expanded.c -I"${FOREC_ANALYSER_PATH}microblaze/include/" -I"${FOREC_ANALYSER_PATH}microblaze/drivers/counter_dfsl_v1_00_a/src/" -I"${FOREC_ANALYSER_PATH}microblaze/drivers/forec_mutex_v1_00_a/src/"
	mb-gcc -O0 -g ${name}_expanded.c -o $elfName.elf -mno-xl-soft-mul -mhard-float -mxl-float-convert -mxl-float-sqrt -mno-xl-soft-div -mcpu=v8.00.b -T forec_linker_script.ld -L"${FOREC_ANALYSER_PATH}microblaze/lib/"
	...
	echo $name $count
	elfName=${name}_timed.$count
	forecc -d1 -t42661 $name.forec $name.$count.foreh >> forecc.out
	mb-gcc -E -CC $name.c -o ${name}_expanded.c -I"${FOREC_ANALYSER_PATH}microblaze/include/" -I"${FOREC_ANALYSER_PATH}microblaze/drivers/counter_dfsl_v1_00_a/src/" -I"${FOREC_ANALYSER_PATH}microblaze/drivers/forec_mutex_v1_00_a/src/"
	mb-gcc -O0 -g ${name}_expanded.c -o $elfName.elf -mno-xl-soft-mul -mhard-float -mxl-float-convert -mxl-float-sqrt -mno-xl-soft-div -mcpu=v8.00.b -T forec_linker_script.ld -L"${FOREC_ANALYSER_PATH}microblaze/lib/"
	...
	echo $name $count
	elfName=${name}_timed.$count
	forecc -d1 -t43331 $name.forec $name.$count.foreh >> forecc.out
	mb-gcc -E -CC $name.c -o ${name}_expanded.c -I"${FOREC_ANALYSER_PATH}microblaze/include/" -I"${FOREC_ANALYSER_PATH}microblaze/drivers/counter_dfsl_v1_00_a/src/" -I"${FOREC_ANALYSER_PATH}microblaze/drivers/forec_mutex_v1_00_a/src/"
	mb-gcc -O0 -g ${name}_expanded.c -o $elfName.elf -mno-xl-soft-mul -mhard-float -mxl-float-convert -mxl-float-sqrt -mno-xl-soft-div -mcpu=v8.00.b -T forec_linker_script.ld -L"${FOREC_ANALYSER_PATH}microblaze/lib/"
	...
	echo $name $count
	elfName=${name}_timed.$count
	forecc -d1 -t33601 $name.forec $name.$count.foreh >> forecc.out
	mb-gcc -E -CC $name.c -o ${name}_expanded.c -I"${FOREC_ANALYSER_PATH}microblaze/include/" -I"${FOREC_ANALYSER_PATH}microblaze/drivers/counter_dfsl_v1_00_a/src/" -I"${FOREC_ANALYSER_PATH}microblaze/drivers/forec_mutex_v1_00_a/src/"
	mb-gcc -O0 -g ${name}_expanded.c -o $elfName.elf -mno-xl-soft-mul -mhard-float -mxl-float-convert -mxl-float-sqrt -mno-xl-soft-div -mcpu=v8.00.b -T forec_linker_script.ld -L"${FOREC_ANALYSER_PATH}microblaze/lib/"
