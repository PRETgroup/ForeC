...
typedef struct {
	/* shared */ int *** value;
	unsigned short int status;
} Shared_matrixA__global_0_0;
Shared_matrixA__global_0_0 matrixA_ptr__global_0_0 = {.value = &matrixA__global_0_0, .status = FOREC_SHARED_UNMODIFIED};
typedef struct {
	/* shared */ int *** value;
	unsigned short int status;
} Shared_matrixB__global_0_0;
Shared_matrixB__global_0_0 matrixB_ptr__global_0_0 = {.value = &matrixB__global_0_0, .status = FOREC_SHARED_UNMODIFIED};
typedef struct {
	/* shared */ int *** value;
	unsigned short int status;
} Shared_matrixC__global_0_0;
Shared_matrixC__global_0_0 matrixC_ptr__global_0_0 = {.value = &matrixC__global_0_0, .status = FOREC_SHARED_UNMODIFIED};
...
// initialiseMatrixA
Shared_matrixA__global_0_0 matrixA_ptr__global_0_0_copy_initialiseMatrixA = {.status = FOREC_SHARED_UNMODIFIED};
// initialiseMatrixB
Shared_matrixB__global_0_0 matrixB_ptr__global_0_0_copy_initialiseMatrixB = {.status = FOREC_SHARED_UNMODIFIED};
// initialiseMatrixC
Shared_matrixC__global_0_0 matrixC_ptr__global_0_0_copy_initialiseMatrixC = {.status = FOREC_SHARED_UNMODIFIED};
// main
// multiplyMatrix0
Shared_matrixA__global_0_0 matrixA_ptr__global_0_0_copy_multiplyMatrix0 = {.status = FOREC_SHARED_UNMODIFIED};
Shared_matrixB__global_0_0 matrixB_ptr__global_0_0_copy_multiplyMatrix0 = {.status = FOREC_SHARED_UNMODIFIED};
Shared_matrixC__global_0_0 matrixC_ptr__global_0_0_copy_multiplyMatrix0 = {.status = FOREC_SHARED_UNMODIFIED};
// multiplyMatrix1
Shared_matrixA__global_0_0 matrixA_ptr__global_0_0_copy_multiplyMatrix1 = {.status = FOREC_SHARED_UNMODIFIED};
Shared_matrixB__global_0_0 matrixB_ptr__global_0_0_copy_multiplyMatrix1 = {.status = FOREC_SHARED_UNMODIFIED};
Shared_matrixC__global_0_0 matrixC_ptr__global_0_0_copy_multiplyMatrix1 = {.status = FOREC_SHARED_UNMODIFIED};
// multiplyMatrix2
Shared_matrixA__global_0_0 matrixA_ptr__global_0_0_copy_multiplyMatrix2 = {.status = FOREC_SHARED_UNMODIFIED};
Shared_matrixB__global_0_0 matrixB_ptr__global_0_0_copy_multiplyMatrix2 = {.status = FOREC_SHARED_UNMODIFIED};
Shared_matrixC__global_0_0 matrixC_ptr__global_0_0_copy_multiplyMatrix2 = {.status = FOREC_SHARED_UNMODIFIED};
// multiplyMatrix3
Shared_matrixA__global_0_0 matrixA_ptr__global_0_0_copy_multiplyMatrix3 = {.status = FOREC_SHARED_UNMODIFIED};
Shared_matrixB__global_0_0 matrixB_ptr__global_0_0_copy_multiplyMatrix3 = {.status = FOREC_SHARED_UNMODIFIED};
Shared_matrixC__global_0_0 matrixC_ptr__global_0_0_copy_multiplyMatrix3 = {.status = FOREC_SHARED_UNMODIFIED};
...
void *forecMain(void *args) {
	...
	char **args__main_0_0 = arguments->argv;
...
mainParCore0: {
	...
	for (i__main_0_0 = 0; i__main_0_0 < NUM_TO_AVERAGE__main_0_0; i__main_0_0++) {
		...
		for (i__main_1_0 = 0; i__main_1_0 < REPEAT__global_0_0; i__main_1_0++) {
		...
		// forec:scheduler:iterationEnd:for1_1:start
		// Synchronise end of iteration
		mainParParent.parId = -2;
		mainParParent.parStatus = FOREC_PAR_ON;
		mainParParent.programCounter = &&for1_1_endAddress;
		goto mainParHandlerMaster0;
		for1_1_endAddress:;
		// forec:scheduler:iterationEnd:for1_1:end
	}
...
*=============================================================*/
	...
	*-------------------------------------------------------------*/
	...
	// Thread local declarations -----------------------------------
	Shared_matrixA__global_0_0 matrixA_ptr__global_0_0_copy_initialiseMatrixA_local;

	// Thread body -------------------------------------------------
	initialiseMatrixA__thread: {
		// Initialise the local copies of shared variables.
		matrixA_ptr__global_0_0_copy_initialiseMatrixA_local.value = matrixA_ptr__global_0_0.value;
		matrixA_ptr__global_0_0_copy_initialiseMatrixA_local.status = FOREC_SHARED_UNMODIFIED;
		//--------------------------------------------------------------

		allocateMatrix(matrixA_ptr__global_0_0_copy_initialiseMatrixA_local.value);
		fillMatrix(matrixA_ptr__global_0_0_copy_initialiseMatrixA_local.value);
	...
	*-------------------------------------------------------------*/
	...
	// Thread local declarations -----------------------------------
	Shared_matrixB__global_0_0 matrixB_ptr__global_0_0_copy_initialiseMatrixB_local;

	// Thread body -------------------------------------------------
	initialiseMatrixB__thread: {
		// Initialise the local copies of shared variables.
		matrixB_ptr__global_0_0_copy_initialiseMatrixB_local.value = matrixB_ptr__global_0_0.value;
		matrixB_ptr__global_0_0_copy_initialiseMatrixB_local.status = FOREC_SHARED_UNMODIFIED;
		//--------------------------------------------------------------

		allocateMatrix(matrixB_ptr__global_0_0_copy_initialiseMatrixB_local.value);
		fillMatrix(matrixB_ptr__global_0_0_copy_initialiseMatrixB_local.value);
	...
	*-------------------------------------------------------------*/
	...
	// Thread local declarations -----------------------------------
	Shared_matrixC__global_0_0 matrixC_ptr__global_0_0_copy_initialiseMatrixC_local;

	// Thread body -------------------------------------------------
	initialiseMatrixC__thread: {
		// Initialise the local copies of shared variables.
		matrixC_ptr__global_0_0_copy_initialiseMatrixC_local.value = matrixC_ptr__global_0_0.value;
		matrixC_ptr__global_0_0_copy_initialiseMatrixC_local.status = FOREC_SHARED_UNMODIFIED;
		//--------------------------------------------------------------

		allocateMatrix(matrixC_ptr__global_0_0_copy_initialiseMatrixC_local.value);
		fillMatrix(matrixC_ptr__global_0_0_copy_initialiseMatrixC_local.value);
	...
	*-------------------------------------------------------------*/
	...
	Shared_matrixA__global_0_0 matrixA_ptr__global_0_0_copy_multiplyMatrix0_local;
	Shared_matrixB__global_0_0 matrixB_ptr__global_0_0_copy_multiplyMatrix0_local;
	Shared_matrixC__global_0_0 matrixC_ptr__global_0_0_copy_multiplyMatrix0_local;

	// Thread body -------------------------------------------------
	multiplyMatrix0__thread: {
		// Initialise the local copies of shared variables.
		matrixA_ptr__global_0_0_copy_multiplyMatrix0_local.value = matrixA_ptr__global_0_0.value;
		matrixA_ptr__global_0_0_copy_multiplyMatrix0_local.status = FOREC_SHARED_UNMODIFIED;
		matrixB_ptr__global_0_0_copy_multiplyMatrix0_local.value = matrixB_ptr__global_0_0.value;
		matrixB_ptr__global_0_0_copy_multiplyMatrix0_local.status = FOREC_SHARED_UNMODIFIED;
		matrixC_ptr__global_0_0_copy_multiplyMatrix0_local.value = matrixC_ptr__global_0_0.value;
		matrixC_ptr__global_0_0_copy_multiplyMatrix0_local.status = FOREC_SHARED_UNMODIFIED;
		//--------------------------------------------------------------

		RANGE__multiplyMatrix0_0_0 = 150;
		multiplyMatrix(matrixA_ptr__global_0_0_copy_multiplyMatrix0_local.value, matrixB_ptr__global_0_0_copy_multiplyMatrix0_local.value, matrixC_ptr__global_0_0_copy_multiplyMatrix0_local.value, 0*RANGE__multiplyMatrix0_0_0);
	...
	*-------------------------------------------------------------*/
	...
	Shared_matrixA__global_0_0 matrixA_ptr__global_0_0_copy_multiplyMatrix1_local;
	Shared_matrixB__global_0_0 matrixB_ptr__global_0_0_copy_multiplyMatrix1_local;
	Shared_matrixC__global_0_0 matrixC_ptr__global_0_0_copy_multiplyMatrix1_local;

	// Thread body -------------------------------------------------
	multiplyMatrix1__thread: {
		// Initialise the local copies of shared variables.
		matrixA_ptr__global_0_0_copy_multiplyMatrix1_local.value = matrixA_ptr__global_0_0.value;
		matrixA_ptr__global_0_0_copy_multiplyMatrix1_local.status = FOREC_SHARED_UNMODIFIED;
		matrixB_ptr__global_0_0_copy_multiplyMatrix1_local.value = matrixB_ptr__global_0_0.value;
		matrixB_ptr__global_0_0_copy_multiplyMatrix1_local.status = FOREC_SHARED_UNMODIFIED;
		matrixC_ptr__global_0_0_copy_multiplyMatrix1_local.value = matrixC_ptr__global_0_0.value;
		matrixC_ptr__global_0_0_copy_multiplyMatrix1_local.status = FOREC_SHARED_UNMODIFIED;
		//--------------------------------------------------------------

		RANGE__multiplyMatrix1_0_0 = 150;
		multiplyMatrix(matrixA_ptr__global_0_0_copy_multiplyMatrix1_local.value, matrixB_ptr__global_0_0_copy_multiplyMatrix1_local.value, matrixC_ptr__global_0_0_copy_multiplyMatrix1_local.value, 1*RANGE__multiplyMatrix1_0_0);
	...
	*-------------------------------------------------------------*/
	...
	Shared_matrixA__global_0_0 matrixA_ptr__global_0_0_copy_multiplyMatrix2_local;
	Shared_matrixB__global_0_0 matrixB_ptr__global_0_0_copy_multiplyMatrix2_local;
	Shared_matrixC__global_0_0 matrixC_ptr__global_0_0_copy_multiplyMatrix2_local;

	// Thread body -------------------------------------------------
	multiplyMatrix2__thread: {
		// Initialise the local copies of shared variables.
		matrixA_ptr__global_0_0_copy_multiplyMatrix2_local.value = matrixA_ptr__global_0_0.value;
		matrixA_ptr__global_0_0_copy_multiplyMatrix2_local.status = FOREC_SHARED_UNMODIFIED;
		matrixB_ptr__global_0_0_copy_multiplyMatrix2_local.value = matrixB_ptr__global_0_0.value;
		matrixB_ptr__global_0_0_copy_multiplyMatrix2_local.status = FOREC_SHARED_UNMODIFIED;
		matrixC_ptr__global_0_0_copy_multiplyMatrix2_local.value = matrixC_ptr__global_0_0.value;
		matrixC_ptr__global_0_0_copy_multiplyMatrix2_local.status = FOREC_SHARED_UNMODIFIED;
		//--------------------------------------------------------------

		RANGE__multiplyMatrix2_0_0 = 150;
		multiplyMatrix(matrixA_ptr__global_0_0_copy_multiplyMatrix2_local.value, matrixB_ptr__global_0_0_copy_multiplyMatrix2_local.value, matrixC_ptr__global_0_0_copy_multiplyMatrix2_local.value, 2*RANGE__multiplyMatrix2_0_0);
	...
	*-------------------------------------------------------------*/
	...
	Shared_matrixA__global_0_0 matrixA_ptr__global_0_0_copy_multiplyMatrix3_local;
	Shared_matrixB__global_0_0 matrixB_ptr__global_0_0_copy_multiplyMatrix3_local;
	Shared_matrixC__global_0_0 matrixC_ptr__global_0_0_copy_multiplyMatrix3_local;

	// Thread body -------------------------------------------------
	multiplyMatrix3__thread: {
		// Initialise the local copies of shared variables.
		matrixA_ptr__global_0_0_copy_multiplyMatrix3_local.value = matrixA_ptr__global_0_0.value;
		matrixA_ptr__global_0_0_copy_multiplyMatrix3_local.status = FOREC_SHARED_UNMODIFIED;
		matrixB_ptr__global_0_0_copy_multiplyMatrix3_local.value = matrixB_ptr__global_0_0.value;
		matrixB_ptr__global_0_0_copy_multiplyMatrix3_local.status = FOREC_SHARED_UNMODIFIED;
		matrixC_ptr__global_0_0_copy_multiplyMatrix3_local.value = matrixC_ptr__global_0_0.value;
		matrixC_ptr__global_0_0_copy_multiplyMatrix3_local.status = FOREC_SHARED_UNMODIFIED;
		//--------------------------------------------------------------

		RANGE__multiplyMatrix3_0_0 = 150;
		multiplyMatrix(matrixA_ptr__global_0_0_copy_multiplyMatrix3_local.value, matrixB_ptr__global_0_0_copy_multiplyMatrix3_local.value, matrixC_ptr__global_0_0_copy_multiplyMatrix3_local.value, 3*RANGE__multiplyMatrix3_0_0);
...
void multiplyMatrix(int *** matrixA__multiplyMatrix_0_0, int *** matrixB__multiplyMatrix_0_0, int *** matrixC__multiplyMatrix_0_0, const int startIndex__multiplyMatrix_0_0) {
	...
	for (i__multiplyMatrix_0_0 = startIndex__multiplyMatrix_0_0; i__multiplyMatrix_0_0 < startIndex__multiplyMatrix_0_0 + RANGE__multiplyMatrix_0_0; i__multiplyMatrix_0_0++) {
		...
		for (j__multiplyMatrix_1_0 = 0; j__multiplyMatrix_1_0 < SIZE__multiplyMatrix_0_0; j__multiplyMatrix_1_0++) {
			...
			// forec:iteration:for1_6:bound:600:600
		}
		// forec:iteration:for1_7:bound:150:150
	}
}
