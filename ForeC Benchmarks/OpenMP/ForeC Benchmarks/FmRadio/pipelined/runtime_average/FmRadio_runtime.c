...
mainParCore0: {
	...
	for (i__main_0_0 = 0; i__main_0_0 < NUM_TO_AVERAGE__main_0_0; i__main_0_0++) {
		...
		while (fread(read_buffer__main_1_0, sizeof(float), 16, input_file__global_0_0) == 16) {
			for (i__main_2_3 = 0; i__main_2_3 < 8; i__main_2_3++) {
				fm_quad_demod(&fm_qd_conf__main_1_0, read_buffer__main_1_0[i__main_2_3*2], read_buffer__main_1_0[i__main_2_3*2 + 1], &fm_qd_value__global_0_0_copy_main_local.value);
				fm_qd_buffer__global_0_0_copy_main_local.value[i__main_2_3] = fm_qd_value__global_0_0_copy_main_local.value;
				...
				ffd_buffer__global_0_0_copy_main_local.value[i__main_2_3] = ffd_value__global_0_0;
		...
		// forec:scheduler:iterationEnd:for1_2:start
		// Synchronise end of iteration
		mainParParent.parId = -2;
		mainParParent.parStatus = FOREC_PAR_ON;
		mainParParent.programCounter = &&for1_2_endAddress;
		goto mainParHandlerMaster0;
		for1_2_endAddress:;
		// forec:scheduler:iterationEnd:for1_2:end
	}
...
float ntaps_filter_ffd(ntaps_filter_conf__global_0_0 *conf__ntaps_filter_ffd_0_0, const int input_size__ntaps_filter_ffd_0_0, const float input_values__ntaps_filter_ffd_0_0[]) {
	...
	for (i__ntaps_filter_ffd_0_0 = 0; i__ntaps_filter_ffd_0_0 < conf__ntaps_filter_ffd_0_0->decimation; i__ntaps_filter_ffd_0_0++) {
		...
		// forec:iteration:for1_11:bound:1:8
	}
