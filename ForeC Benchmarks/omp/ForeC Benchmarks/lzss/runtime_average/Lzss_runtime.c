...
typedef struct {
	/* shared */ int *value;
	unsigned short int status;
} Shared_offset_thread__global_0_0;
Shared_offset_thread__global_0_0 offset_thread_ptr__global_0_0 = {.value = offset_thread__global_0_0, .status = FOREC_SHARED_UNMODIFIED} /* combine with first */;
...
typedef struct {
	/* shared */ int *value;
	unsigned short int status;
} Shared_matches_thread__global_0_0;
Shared_matches_thread__global_0_0 matches_thread_ptr__global_0_0 = {.value = matches_thread__global_0_0, .status = FOREC_SHARED_UNMODIFIED} /* combine with first */;
...
struct _IO_FILE *stderr__global_0_0;

#define stderr__global_0_0 stderr

struct _IO_FILE ** stderr_ptr_0__global_0_0 = &stderr__global_0_0;
struct _IO_FILE ** stderr_ptr_1__global_0_0 = &stderr__global_0_0;
struct _IO_FILE ** stderr_ptr_2__global_0_0 = &stderr__global_0_0;
struct _IO_FILE ** stderr_ptr_3__global_0_0 = &stderr__global_0_0;
struct _IO_FILE *stdout__global_0_0;

#define stdout__global_0_0 stdout

struct _IO_FILE ** stdout_ptr_0__global_0_0 = &stdout__global_0_0;
struct _IO_FILE ** stdout_ptr_1__global_0_0 = &stdout__global_0_0;
struct _IO_FILE ** stdout_ptr_2__global_0_0 = &stdout__global_0_0;
...
// longestMatch0
Shared_offset_thread__global_0_0 offset_thread_ptr__global_0_0_copy_longestMatch0 = {.status = FOREC_SHARED_UNMODIFIED};
Shared_matches_thread__global_0_0 matches_thread_ptr__global_0_0_copy_longestMatch0 = {.status = FOREC_SHARED_UNMODIFIED};
...
// longestMatch1
Shared_offset_thread__global_0_0 offset_thread_ptr__global_0_0_copy_longestMatch1 = {.status = FOREC_SHARED_UNMODIFIED};
Shared_matches_thread__global_0_0 matches_thread_ptr__global_0_0_copy_longestMatch1 = {.status = FOREC_SHARED_UNMODIFIED};
...
// longestMatch2
Shared_offset_thread__global_0_0 offset_thread_ptr__global_0_0_copy_longestMatch2 = {.status = FOREC_SHARED_UNMODIFIED};
Shared_matches_thread__global_0_0 matches_thread_ptr__global_0_0_copy_longestMatch2 = {.status = FOREC_SHARED_UNMODIFIED};
...
// longestMatch3
Shared_offset_thread__global_0_0 offset_thread_ptr__global_0_0_copy_longestMatch3 = {.status = FOREC_SHARED_UNMODIFIED};
Shared_matches_thread__global_0_0 matches_thread_ptr__global_0_0_copy_longestMatch3 = {.status = FOREC_SHARED_UNMODIFIED};
...
// main
Shared_offset_thread__global_0_0 offset_thread_ptr__global_0_0_copy_main = {.status = FOREC_SHARED_UNMODIFIED};
Shared_matches_thread__global_0_0 matches_thread_ptr__global_0_0_copy_main = {.status = FOREC_SHARED_UNMODIFIED};
Shared_window__global_0_0 window__global_0_0_copy_main = {.status = FOREC_SHARED_UNMODIFIED};
Shared_lookAhead__global_0_0 lookAhead__global_0_0_copy_main = {.status = FOREC_SHARED_UNMODIFIED};
...
*=============================================================*/
	...
	*-------------------------------------------------------------*/
	...
	Shared_window__global_0_0 window__global_0_0_copy_main_local;
	Shared_lookAhead__global_0_0 lookAhead__global_0_0_copy_main_local;
	Shared_offset_thread__global_0_0 offset_thread_ptr__global_0_0_copy_main_local;
	Shared_matches_thread__global_0_0 matches_thread_ptr__global_0_0_copy_main_local;

mainParCore0: {
	// Initialise the local copies of shared variables.
	offset_thread_ptr__global_0_0_copy_main_local = offset_thread_ptr__global_0_0;
	matches_thread_ptr__global_0_0_copy_main_local = matches_thread_ptr__global_0_0;
	window__global_0_0_copy_main_local = window__global_0_0;
	lookAhead__global_0_0_copy_main_local = lookAhead__global_0_0;
	//--------------------------------------------------------------
	...
	for (i__main_0_0 = 0; i__main_0_0 < NUM_TO_AVERAGE__main_0_0; i__main_0_0++) {
		...
		if (argc__main_0_0 > 1 && !strcmp(argv__main_0_0[1], "-h")) {
			...
			if (argc__main_0_0 > 3 && !strcmp(argv__main_0_0[1], "-c")) {
				...
				for (count__main_3_0 = 3; count__main_3_0 < argc__main_0_0; count__main_3_0++) {
					fileInfo__global_0_0.filename = argv__main_0_0[count__main_3_0];
					...
					if ((fileInfo__global_0_0.p_file = fopen(fileInfo__global_0_0.filename, "r")) == null__global_0_0) {
						...
						if (fileInfo__global_0_0.isDir) {
							...
							Fifo_init(&window__global_0_0_copy_main_local.value, WINLENGTH__global_0_0);
							Fifo_push_back(&window__global_0_0_copy_main_local.value, fgetc(fileInfo__global_0_0.p_file));
							writeToArchive(window__global_0_0_copy_main_local.value, &offset__global_0_0, &matches__global_0_0, &archiveInfo__global_0_0, offset_thread__global_0_0, matches_thread__global_0_0);
							Fifo_init(&lookAhead__global_0_0_copy_main_local.value, LKLENGTH__global_0_0);
							Fifo_push_back(&lookAhead__global_0_0_copy_main_local.value, fgetc(fileInfo__global_0_0.p_file));
							while (lookAhead__global_0_0_copy_main_local.value.written_size < LKLENGTH__global_0_0) {
								Fifo_push_back(&lookAhead__global_0_0_copy_main_local.value, fgetc(fileInfo__global_0_0.p_file));
							}
							...
							while (!feof(fileInfo__global_0_0.p_file)) {
								...
								offset_thread_ptr__global_0_0_copy_main = offset_thread_ptr__global_0_0_copy_main_local;
								offset_thread_ptr__global_0_0.value = offset_thread_ptr__global_0_0_copy_main_local.value;
								matches_thread_ptr__global_0_0_copy_main = matches_thread_ptr__global_0_0_copy_main_local;
								matches_thread_ptr__global_0_0.value = matches_thread_ptr__global_0_0_copy_main_local.value;
								window__global_0_0_copy_main = window__global_0_0_copy_main_local;
								window__global_0_0.value = window__global_0_0_copy_main_local.value;
								lookAhead__global_0_0_copy_main = lookAhead__global_0_0_copy_main_local;
								lookAhead__global_0_0.value = lookAhead__global_0_0_copy_main_local.value;
								...
								writeToArchive(lookAhead__global_0_0_copy_main_local.value, &offset__global_0_0, &matches__global_0_0, &archiveInfo__global_0_0, offset_thread__global_0_0, matches_thread__global_0_0);
								count__main_6_0 = 1;
								do {
									if (window__global_0_0_copy_main_local.value.written_size >= WINLENGTH__global_0_0) {
										Fifo_pop_front(&window__global_0_0_copy_main_local.value);
									} else {
										// if1
									}
									Fifo_push_back(&window__global_0_0_copy_main_local.value, Fifo_pop_front(&lookAhead__global_0_0_copy_main_local.value));
									Fifo_push_back(&lookAhead__global_0_0_copy_main_local.value, fgetc(fileInfo__global_0_0.p_file));
								} while (count__main_6_0++ < matches__global_0_0);
							...
							for (i__main_6_0 = 0; i__main_6_0 < NUM_THREADS__global_0_0; i__main_6_0++) {
								matches_thread__global_0_0[i__main_6_0] = 0;
							}
							for (count__main_6_0 = 0; count__main_6_0 < LKLENGTH__global_0_0 - 1 && Fifo_at(lookAhead__global_0_0_copy_main_local.value, 0) != EOF__global_0_0; count__main_6_0++) {
								writeToArchive(lookAhead__global_0_0_copy_main_local.value, &offset__global_0_0, &matches__global_0_0, &archiveInfo__global_0_0, offset_thread__global_0_0, matches_thread__global_0_0);
								Fifo_pop_front(&lookAhead__global_0_0_copy_main_local.value);
							}
	...
	window__global_0_0 = window__global_0_0_copy_main_local;
	lookAhead__global_0_0 = lookAhead__global_0_0_copy_main_local;
...
mainReactionEndMaster0: {
	...
	if (parId == 0) {
		...
		Shared_offset_thread__global_0_0 *modified_offset_thread_ptr__global_0_0[4];
		// Find the modified copies.
		if (offset_thread_ptr__global_0_0_copy_longestMatch0.status == FOREC_SHARED_MODIFIED) {
			offset_thread_ptr__global_0_0_copy_longestMatch0.status = FOREC_SHARED_UNMODIFIED;
			modified_offset_thread_ptr__global_0_0[numberOfModifiedCopies] = &offset_thread_ptr__global_0_0_copy_longestMatch0;
			++numberOfModifiedCopies;
		}
		if (offset_thread_ptr__global_0_0_copy_longestMatch1.status == FOREC_SHARED_MODIFIED) {
			offset_thread_ptr__global_0_0_copy_longestMatch1.status = FOREC_SHARED_UNMODIFIED;
			modified_offset_thread_ptr__global_0_0[numberOfModifiedCopies] = &offset_thread_ptr__global_0_0_copy_longestMatch1;
			++numberOfModifiedCopies;
		}
		if (offset_thread_ptr__global_0_0_copy_longestMatch2.status == FOREC_SHARED_MODIFIED) {
			offset_thread_ptr__global_0_0_copy_longestMatch2.status = FOREC_SHARED_UNMODIFIED;
			modified_offset_thread_ptr__global_0_0[numberOfModifiedCopies] = &offset_thread_ptr__global_0_0_copy_longestMatch2;
			++numberOfModifiedCopies;
		}
		if (offset_thread_ptr__global_0_0_copy_longestMatch3.status == FOREC_SHARED_MODIFIED) {
			offset_thread_ptr__global_0_0_copy_longestMatch3.status = FOREC_SHARED_UNMODIFIED;
			modified_offset_thread_ptr__global_0_0[numberOfModifiedCopies] = &offset_thread_ptr__global_0_0_copy_longestMatch3;
			++numberOfModifiedCopies;
		}
		// Assign the first modified copy.
		if (numberOfModifiedCopies > 0) {
			offset_thread_ptr__global_0_0.value = modified_offset_thread_ptr__global_0_0[0]->value;
		}
		// Combine with the remaining modified copies.
		for (index = 1; index < numberOfModifiedCopies; ++index) {
			offset_thread_ptr__global_0_0.value = first(&offset_thread_ptr__global_0_0.value, &modified_offset_thread_ptr__global_0_0[index]->value);
		}

		// matches_thread_ptr__global_0_0
		numberOfModifiedCopies = 0;
		Shared_matches_thread__global_0_0 *modified_matches_thread_ptr__global_0_0[4];
		// Find the modified copies.
		if (matches_thread_ptr__global_0_0_copy_longestMatch0.status == FOREC_SHARED_MODIFIED) {
			matches_thread_ptr__global_0_0_copy_longestMatch0.status = FOREC_SHARED_UNMODIFIED;
			modified_matches_thread_ptr__global_0_0[numberOfModifiedCopies] = &matches_thread_ptr__global_0_0_copy_longestMatch0;
			++numberOfModifiedCopies;
		}
		if (matches_thread_ptr__global_0_0_copy_longestMatch1.status == FOREC_SHARED_MODIFIED) {
			matches_thread_ptr__global_0_0_copy_longestMatch1.status = FOREC_SHARED_UNMODIFIED;
			modified_matches_thread_ptr__global_0_0[numberOfModifiedCopies] = &matches_thread_ptr__global_0_0_copy_longestMatch1;
			++numberOfModifiedCopies;
		}
		if (matches_thread_ptr__global_0_0_copy_longestMatch2.status == FOREC_SHARED_MODIFIED) {
			matches_thread_ptr__global_0_0_copy_longestMatch2.status = FOREC_SHARED_UNMODIFIED;
			modified_matches_thread_ptr__global_0_0[numberOfModifiedCopies] = &matches_thread_ptr__global_0_0_copy_longestMatch2;
			++numberOfModifiedCopies;
		}
		if (matches_thread_ptr__global_0_0_copy_longestMatch3.status == FOREC_SHARED_MODIFIED) {
			matches_thread_ptr__global_0_0_copy_longestMatch3.status = FOREC_SHARED_UNMODIFIED;
			modified_matches_thread_ptr__global_0_0[numberOfModifiedCopies] = &matches_thread_ptr__global_0_0_copy_longestMatch3;
			++numberOfModifiedCopies;
		}
		// Assign the first modified copy.
		if (numberOfModifiedCopies > 0) {
			matches_thread_ptr__global_0_0.value = modified_matches_thread_ptr__global_0_0[0]->value;
		}
		// Combine with the remaining modified copies.
		for (index = 1; index < numberOfModifiedCopies; ++index) {
			matches_thread_ptr__global_0_0.value = first(&matches_thread_ptr__global_0_0.value, &modified_matches_thread_ptr__global_0_0[index]->value);
		}
	} else {
		// Nothing.
	}
...
*=============================================================*/
	...
	*-------------------------------------------------------------*/
	...
	// Thread local declarations -----------------------------------
	Shared_offset_thread__global_0_0 offset_thread_ptr__global_0_0_copy_longestMatch0_local;
	Shared_matches_thread__global_0_0 matches_thread_ptr__global_0_0_copy_longestMatch0_local;
	...
	longestMatch0__thread: {
		// Initialise the local copies of shared variables.
		offset_thread_ptr__global_0_0_copy_longestMatch0_local.value = offset_thread_ptr__global_0_0_copy_main.value;
		offset_thread_ptr__global_0_0_copy_longestMatch0_local.status = FOREC_SHARED_UNMODIFIED;
		matches_thread_ptr__global_0_0_copy_longestMatch0_local.value = matches_thread_ptr__global_0_0_copy_main.value;
		matches_thread_ptr__global_0_0_copy_longestMatch0_local.status = FOREC_SHARED_UNMODIFIED;
		window__global_0_0_copy_longestMatch0_local.value = window__global_0_0_copy_main.value;
		window__global_0_0_copy_longestMatch0_local.status = FOREC_SHARED_UNMODIFIED;
		lookAhead__global_0_0_copy_longestMatch0_local.value = lookAhead__global_0_0_copy_main.value;
		lookAhead__global_0_0_copy_longestMatch0_local.status = FOREC_SHARED_UNMODIFIED;
		//--------------------------------------------------------------

		longestMatch(window__global_0_0_copy_longestMatch0_local.value, lookAhead__global_0_0_copy_longestMatch0_local.value, 0, &offset_thread_ptr__global_0_0_copy_longestMatch0_local.value, &matches_thread_ptr__global_0_0_copy_longestMatch0_local.value);

		//--------------------------------------------------------------
		// Write the defined shared variables back to their global copy.
		offset_thread_ptr__global_0_0_copy_longestMatch0 = offset_thread_ptr__global_0_0_copy_longestMatch0_local;
		matches_thread_ptr__global_0_0_copy_longestMatch0 = matches_thread_ptr__global_0_0_copy_longestMatch0_local;
	...
	*-------------------------------------------------------------*/
	...
	// Thread local declarations -----------------------------------
	Shared_offset_thread__global_0_0 offset_thread_ptr__global_0_0_copy_longestMatch1_local;
	Shared_matches_thread__global_0_0 matches_thread_ptr__global_0_0_copy_longestMatch1_local;
	...
	longestMatch1__thread: {
		// Initialise the local copies of shared variables.
		offset_thread_ptr__global_0_0_copy_longestMatch1_local.value = offset_thread_ptr__global_0_0_copy_main.value;
		offset_thread_ptr__global_0_0_copy_longestMatch1_local.status = FOREC_SHARED_UNMODIFIED;
		matches_thread_ptr__global_0_0_copy_longestMatch1_local.value = matches_thread_ptr__global_0_0_copy_main.value;
		matches_thread_ptr__global_0_0_copy_longestMatch1_local.status = FOREC_SHARED_UNMODIFIED;
		window__global_0_0_copy_longestMatch1_local.value = window__global_0_0_copy_main.value;
		window__global_0_0_copy_longestMatch1_local.status = FOREC_SHARED_UNMODIFIED;
		lookAhead__global_0_0_copy_longestMatch1_local.value = lookAhead__global_0_0_copy_main.value;
		lookAhead__global_0_0_copy_longestMatch1_local.status = FOREC_SHARED_UNMODIFIED;
		//--------------------------------------------------------------

		longestMatch(window__global_0_0_copy_longestMatch1_local.value, lookAhead__global_0_0_copy_longestMatch1_local.value, 1, &offset_thread_ptr__global_0_0_copy_longestMatch1_local.value, &matches_thread_ptr__global_0_0_copy_longestMatch1_local.value);

		//--------------------------------------------------------------
		// Write the defined shared variables back to their global copy.
		offset_thread_ptr__global_0_0_copy_longestMatch1 = offset_thread_ptr__global_0_0_copy_longestMatch1_local;
		matches_thread_ptr__global_0_0_copy_longestMatch1 = matches_thread_ptr__global_0_0_copy_longestMatch1_local;
	...
	*-------------------------------------------------------------*/
	...
	// Thread local declarations -----------------------------------
	Shared_offset_thread__global_0_0 offset_thread_ptr__global_0_0_copy_longestMatch2_local;
	Shared_matches_thread__global_0_0 matches_thread_ptr__global_0_0_copy_longestMatch2_local;
	...
	longestMatch2__thread: {
		// Initialise the local copies of shared variables.
		offset_thread_ptr__global_0_0_copy_longestMatch2_local.value = offset_thread_ptr__global_0_0_copy_main.value;
		offset_thread_ptr__global_0_0_copy_longestMatch2_local.status = FOREC_SHARED_UNMODIFIED;
		matches_thread_ptr__global_0_0_copy_longestMatch2_local.value = matches_thread_ptr__global_0_0_copy_main.value;
		matches_thread_ptr__global_0_0_copy_longestMatch2_local.status = FOREC_SHARED_UNMODIFIED;
		window__global_0_0_copy_longestMatch2_local.value = window__global_0_0_copy_main.value;
		window__global_0_0_copy_longestMatch2_local.status = FOREC_SHARED_UNMODIFIED;
		lookAhead__global_0_0_copy_longestMatch2_local.value = lookAhead__global_0_0_copy_main.value;
		lookAhead__global_0_0_copy_longestMatch2_local.status = FOREC_SHARED_UNMODIFIED;
		//--------------------------------------------------------------

		longestMatch(window__global_0_0_copy_longestMatch2_local.value, lookAhead__global_0_0_copy_longestMatch2_local.value, 2, &offset_thread_ptr__global_0_0_copy_longestMatch2_local.value, &matches_thread_ptr__global_0_0_copy_longestMatch2_local.value);

		//--------------------------------------------------------------
		// Write the defined shared variables back to their global copy.
		offset_thread_ptr__global_0_0_copy_longestMatch2 = offset_thread_ptr__global_0_0_copy_longestMatch2_local;
		matches_thread_ptr__global_0_0_copy_longestMatch2 = matches_thread_ptr__global_0_0_copy_longestMatch2_local;
	...
	*-------------------------------------------------------------*/
	...
	// Thread local declarations -----------------------------------
	Shared_offset_thread__global_0_0 offset_thread_ptr__global_0_0_copy_longestMatch3_local;
	Shared_matches_thread__global_0_0 matches_thread_ptr__global_0_0_copy_longestMatch3_local;
	...
	longestMatch3__thread: {
		// Initialise the local copies of shared variables.
		offset_thread_ptr__global_0_0_copy_longestMatch3_local.value = offset_thread_ptr__global_0_0_copy_main.value;
		offset_thread_ptr__global_0_0_copy_longestMatch3_local.status = FOREC_SHARED_UNMODIFIED;
		matches_thread_ptr__global_0_0_copy_longestMatch3_local.value = matches_thread_ptr__global_0_0_copy_main.value;
		matches_thread_ptr__global_0_0_copy_longestMatch3_local.status = FOREC_SHARED_UNMODIFIED;
		window__global_0_0_copy_longestMatch3_local.value = window__global_0_0_copy_main.value;
		window__global_0_0_copy_longestMatch3_local.status = FOREC_SHARED_UNMODIFIED;
		lookAhead__global_0_0_copy_longestMatch3_local.value = lookAhead__global_0_0_copy_main.value;
		lookAhead__global_0_0_copy_longestMatch3_local.status = FOREC_SHARED_UNMODIFIED;
		//--------------------------------------------------------------

		longestMatch(window__global_0_0_copy_longestMatch3_local.value, lookAhead__global_0_0_copy_longestMatch3_local.value, 3, &offset_thread_ptr__global_0_0_copy_longestMatch3_local.value, &matches_thread_ptr__global_0_0_copy_longestMatch3_local.value);

		//--------------------------------------------------------------
		// Write the defined shared variables back to their global copy.
		offset_thread_ptr__global_0_0_copy_longestMatch3 = offset_thread_ptr__global_0_0_copy_longestMatch3_local;
		matches_thread_ptr__global_0_0_copy_longestMatch3 = matches_thread_ptr__global_0_0_copy_longestMatch3_local;
