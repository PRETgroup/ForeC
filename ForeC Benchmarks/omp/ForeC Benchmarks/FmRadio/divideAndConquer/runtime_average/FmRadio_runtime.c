...
typedef struct {
	/* shared */ float *value;
	unsigned short int status;
} Shared_band_11_obj__global_0_0;
Shared_band_11_obj__global_0_0 band_11__global_0_0 = {.value = band_11_obj__global_0_0, .status = FOREC_SHARED_UNMODIFIED};
typedef struct {
	/* shared */ float *value;
	unsigned short int status;
} Shared_band_12_obj__global_0_0;
Shared_band_12_obj__global_0_0 band_12__global_0_0 = {.value = band_12_obj__global_0_0, .status = FOREC_SHARED_UNMODIFIED};
typedef struct {
	/* shared */ float *value;
	unsigned short int status;
} Shared_band_21_obj__global_0_0;
Shared_band_21_obj__global_0_0 band_21__global_0_0 = {.value = band_21_obj__global_0_0, .status = FOREC_SHARED_UNMODIFIED};
typedef struct {
	/* shared */ float *value;
	unsigned short int status;
} Shared_band_22_obj__global_0_0;
Shared_band_22_obj__global_0_0 band_22__global_0_0 = {.value = band_22_obj__global_0_0, .status = FOREC_SHARED_UNMODIFIED};
...
// main
Shared_BUFFER_PAIRS__global_0_0 BUFFER_PAIRS__global_0_0_copy_main = {.status = FOREC_SHARED_UNMODIFIED};
Shared_band_11_obj__global_0_0 band_11__global_0_0_copy_main = {.status = FOREC_SHARED_UNMODIFIED};
Shared_band_12_obj__global_0_0 band_12__global_0_0_copy_main = {.status = FOREC_SHARED_UNMODIFIED};
Shared_band_21_obj__global_0_0 band_21__global_0_0_copy_main = {.status = FOREC_SHARED_UNMODIFIED};
Shared_band_22_obj__global_0_0 band_22__global_0_0_copy_main = {.status = FOREC_SHARED_UNMODIFIED};
...
Shared_band_11_obj__global_0_0 band_11__global_0_0_copy_ntaps_filter_ffd_0 = {.status = FOREC_SHARED_UNMODIFIED};
Shared_fm_qd_buffer_array__global_0_0 fm_qd_buffer__global_0_0_copy_ntaps_filter_ffd_0 = {.status = FOREC_SHARED_UNMODIFIED};
// ntaps_filter_ffd_1
Shared_BUFFER_PAIRS__global_0_0 BUFFER_PAIRS__global_0_0_copy_ntaps_filter_ffd_1 = {.status = FOREC_SHARED_UNMODIFIED};
Shared_band_12_obj__global_0_0 band_12__global_0_0_copy_ntaps_filter_ffd_1 = {.status = FOREC_SHARED_UNMODIFIED};
Shared_fm_qd_buffer_array__global_0_0 fm_qd_buffer__global_0_0_copy_ntaps_filter_ffd_1 = {.status = FOREC_SHARED_UNMODIFIED};
// ntaps_filter_ffd_2
Shared_BUFFER_PAIRS__global_0_0 BUFFER_PAIRS__global_0_0_copy_ntaps_filter_ffd_2 = {.status = FOREC_SHARED_UNMODIFIED};
Shared_band_21_obj__global_0_0 band_21__global_0_0_copy_ntaps_filter_ffd_2 = {.status = FOREC_SHARED_UNMODIFIED};
Shared_fm_qd_buffer_array__global_0_0 fm_qd_buffer__global_0_0_copy_ntaps_filter_ffd_2 = {.status = FOREC_SHARED_UNMODIFIED};
// ntaps_filter_ffd_3
Shared_BUFFER_PAIRS__global_0_0 BUFFER_PAIRS__global_0_0_copy_ntaps_filter_ffd_3 = {.status = FOREC_SHARED_UNMODIFIED};
Shared_band_22_obj__global_0_0 band_22__global_0_0_copy_ntaps_filter_ffd_3 = {.status = FOREC_SHARED_UNMODIFIED};
Shared_fm_qd_buffer_array__global_0_0 fm_qd_buffer__global_0_0_copy_ntaps_filter_ffd_3 = {.status = FOREC_SHARED_UNMODIFIED};
...
*=============================================================*/
	...
	*-------------------------------------------------------------*/
	...
	int i__main_0_0;
	int final_audio_frequency__main_1_0;
	float input_rate__main_1_0;
	fm_quad_demod_filter__global_0_0 fm_qd_conf__main_1_0;
	float read_buffer__main_1_0[16];
	ntaps_filter_conf__global_0_0 lp_2_conf__main_1_0;
	ntaps_filter_conf__global_0_0 lp_3_conf__main_1_0;
	float fm_qd_value__main_1_0;
	float ffd_value__main_1_0;
	float ffd_buffer__main_1_0[8];
	float output1__main_1_0;
	float output2__main_1_0;
	short output_short__main_1_0[2];
	float inout_ratio__main_1_0;
	int i__main_2_3;
	...
	Shared_BUFFER_PAIRS__global_0_0 BUFFER_PAIRS__global_0_0_copy_main_local;
	Shared_band_11_obj__global_0_0 band_11__global_0_0_copy_main_local;
	Shared_band_12_obj__global_0_0 band_12__global_0_0_copy_main_local;
	Shared_band_21_obj__global_0_0 band_21__global_0_0_copy_main_local;
	Shared_band_22_obj__global_0_0 band_22__global_0_0_copy_main_local;
	Shared_fm_qd_buffer_array__global_0_0 fm_qd_buffer__global_0_0_copy_main_local;

mainParCore0: {
	// Initialise the local copies of shared variables.
	BUFFER_PAIRS__global_0_0_copy_main_local = BUFFER_PAIRS__global_0_0;
	fm_qd_buffer__global_0_0_copy_main_local = fm_qd_buffer__global_0_0;
	band_11__global_0_0_copy_main_local = band_11__global_0_0;
	band_12__global_0_0_copy_main_local = band_12__global_0_0;
	band_21__global_0_0_copy_main_local = band_21__global_0_0;
	...
	for (i__main_0_0 = 0; i__main_0_0 < NUM_TO_AVERAGE__main_0_0; i__main_0_0++) {
		...
		final_audio_frequency__main_1_0 = 64*KSMPS__global_0_0;
		input_rate__main_1_0 = 512*KSMPS__global_0_0;
		fm_qd_value__main_1_0 = 0.0;
		ffd_value__main_1_0 = 0.0;
		output1__main_1_0 = 0.0;
		output2__main_1_0 = 0.0;
		inout_ratio__main_1_0 = ((int)input_rate__main_1_0)/final_audio_frequency__main_1_0;
		ntaps_filter_ffd_init(&lp_11_conf__global_0_0, 53000, 4000, 1, 1, input_rate__main_1_0, WIN_HANNING__global_0_0);
		ntaps_filter_ffd_init(&lp_12_conf__global_0_0, 23000, 4000, 1, 1, input_rate__main_1_0, WIN_HANNING__global_0_0);
		ntaps_filter_ffd_init(&lp_21_conf__global_0_0, 21000, 2000, 1, 1, input_rate__main_1_0, WIN_HANNING__global_0_0);
		ntaps_filter_ffd_init(&lp_22_conf__global_0_0, 17000, 2000, 1, 1, input_rate__main_1_0, WIN_HANNING__global_0_0);
		ntaps_filter_ffd_init(&lp_2_conf__main_1_0, 15000, 4000, 0.5, inout_ratio__main_1_0, input_rate__main_1_0, WIN_HANNING__global_0_0);
		ntaps_filter_ffd_init(&lp_3_conf__main_1_0, 15000, 4000, 1.0, inout_ratio__main_1_0, input_rate__main_1_0, WIN_HANNING__global_0_0);
		fm_quad_demod_init(&fm_qd_conf__main_1_0);

		while (fread(read_buffer__main_1_0, sizeof(float), 16, input_file__global_0_0) == 16) {
			for (i__main_2_3 = 0; i__main_2_3 < BUFFER_PAIRS__global_0_0_copy_main_local.value; i__main_2_3++) {
				fm_quad_demod(&fm_qd_conf__main_1_0, read_buffer__main_1_0[i__main_2_3*2], read_buffer__main_1_0[i__main_2_3*2 + 1], &fm_qd_value__main_1_0);
				fm_qd_buffer__global_0_0_copy_main_local.value[i__main_2_3] = fm_qd_value__main_1_0;
			...
			BUFFER_PAIRS__global_0_0_copy_main = BUFFER_PAIRS__global_0_0_copy_main_local;
			BUFFER_PAIRS__global_0_0.value = BUFFER_PAIRS__global_0_0_copy_main_local.value;
			...
			for (i__main_2_3 = 0; i__main_2_3 < BUFFER_PAIRS__global_0_0_copy_main_local.value; i__main_2_3++) {
				resume_1__global_0_0[i__main_2_3] = subctract(band_11__global_0_0_copy_main_local.value[i__main_2_3], band_12__global_0_0_copy_main_local.value[i__main_2_3]);
				resume_2__global_0_0[i__main_2_3] = subctract(band_21__global_0_0_copy_main_local.value[i__main_2_3], band_22__global_0_0_copy_main_local.value[i__main_2_3]);
				multiply_square(resume_1__global_0_0[i__main_2_3], resume_2__global_0_0[i__main_2_3], &ffd_value__main_1_0);
				ffd_buffer__main_1_0[i__main_2_3] = ffd_value__main_1_0;
				// forec:iteration:for1_1:bound:8:8
			}
			band_2__global_0_0 = ntaps_filter_ffd(&lp_2_conf__main_1_0, 8, fm_qd_buffer__global_0_0_copy_main_local.value);
			band_3__global_0_0 = ntaps_filter_ffd(&lp_3_conf__main_1_0, 8, ffd_buffer__main_1_0);
			stereo_sum(band_2__global_0_0, band_3__global_0_0, &output1__main_1_0, &output2__main_1_0);
			output_short__main_1_0[0] = dac_cast_trunc_and_normalize_to_short(output1__main_1_0);
			output_short__main_1_0[1] = dac_cast_trunc_and_normalize_to_short(output2__main_1_0);
			fwrite(output_short__main_1_0, sizeof(short), 2, output_file__global_0_0);
			fprintf(text_file__global_0_0, "%-10.5f %-10.5f\n", output1__main_1_0, output2__main_1_0);
...
*=============================================================*/
	...
	*-------------------------------------------------------------*/
	...
	Shared_band_11_obj__global_0_0 band_11__global_0_0_copy_ntaps_filter_ffd_0_local;
	Shared_fm_qd_buffer_array__global_0_0 fm_qd_buffer__global_0_0_copy_ntaps_filter_ffd_0_local;

	// Thread body -------------------------------------------------
	ntaps_filter_ffd_0__thread: {
		// Initialise the local copies of shared variables.
		BUFFER_PAIRS__global_0_0_copy_ntaps_filter_ffd_0_local.value = BUFFER_PAIRS__global_0_0_copy_main.value;
		BUFFER_PAIRS__global_0_0_copy_ntaps_filter_ffd_0_local.status = FOREC_SHARED_UNMODIFIED;
		fm_qd_buffer__global_0_0_copy_ntaps_filter_ffd_0_local.value = fm_qd_buffer__global_0_0_copy_main.value;
	...
	*-------------------------------------------------------------*/
	...
	Shared_band_12_obj__global_0_0 band_12__global_0_0_copy_ntaps_filter_ffd_1_local;
	Shared_fm_qd_buffer_array__global_0_0 fm_qd_buffer__global_0_0_copy_ntaps_filter_ffd_1_local;

	// Thread body -------------------------------------------------
	ntaps_filter_ffd_1__thread: {
		// Initialise the local copies of shared variables.
		BUFFER_PAIRS__global_0_0_copy_ntaps_filter_ffd_1_local.value = BUFFER_PAIRS__global_0_0_copy_main.value;
		BUFFER_PAIRS__global_0_0_copy_ntaps_filter_ffd_1_local.status = FOREC_SHARED_UNMODIFIED;
		fm_qd_buffer__global_0_0_copy_ntaps_filter_ffd_1_local.value = fm_qd_buffer__global_0_0_copy_main.value;
	...
	*-------------------------------------------------------------*/
	...
	Shared_band_21_obj__global_0_0 band_21__global_0_0_copy_ntaps_filter_ffd_2_local;
	Shared_fm_qd_buffer_array__global_0_0 fm_qd_buffer__global_0_0_copy_ntaps_filter_ffd_2_local;

	// Thread body -------------------------------------------------
	ntaps_filter_ffd_2__thread: {
		// Initialise the local copies of shared variables.
		BUFFER_PAIRS__global_0_0_copy_ntaps_filter_ffd_2_local.value = BUFFER_PAIRS__global_0_0_copy_main.value;
		BUFFER_PAIRS__global_0_0_copy_ntaps_filter_ffd_2_local.status = FOREC_SHARED_UNMODIFIED;
		fm_qd_buffer__global_0_0_copy_ntaps_filter_ffd_2_local.value = fm_qd_buffer__global_0_0_copy_main.value;
	...
	*-------------------------------------------------------------*/
	...
	Shared_band_22_obj__global_0_0 band_22__global_0_0_copy_ntaps_filter_ffd_3_local;
	Shared_fm_qd_buffer_array__global_0_0 fm_qd_buffer__global_0_0_copy_ntaps_filter_ffd_3_local;

	// Thread body -------------------------------------------------
	ntaps_filter_ffd_3__thread: {
		// Initialise the local copies of shared variables.
		BUFFER_PAIRS__global_0_0_copy_ntaps_filter_ffd_3_local.value = BUFFER_PAIRS__global_0_0_copy_main.value;
		BUFFER_PAIRS__global_0_0_copy_ntaps_filter_ffd_3_local.status = FOREC_SHARED_UNMODIFIED;
		fm_qd_buffer__global_0_0_copy_ntaps_filter_ffd_3_local.value = fm_qd_buffer__global_0_0_copy_main.value;
		...
		for (i__ntaps_filter_ffd_3_0_0 = 0; i__ntaps_filter_ffd_3_0_0 < BUFFER_PAIRS__global_0_0_copy_ntaps_filter_ffd_3_local.value; i__ntaps_filter_ffd_3_0_0++) {
			...
			// forec:iteration:for1_7:bound:8:8
		}
...
void ntaps_filter_ffd_init(ntaps_filter_conf__global_0_0 *conf__ntaps_filter_ffd_init_0_0, const double cutoff_freq__ntaps_filter_ffd_init_0_0, const double transition_band__ntaps_filter_ffd_init_0_0, double gain__ntaps_filter_ffd_init_0_0, const int decimation__ntaps_filter_ffd_init_0_0, const double sampling_rate__ntaps_filter_ffd_init_0_0, const int window_type__ntaps_filter_ffd_init_0_0) {
	...
	for (n__ntaps_filter_ffd_init_0_0 = 0; n__ntaps_filter_ffd_init_0_0 < conf__ntaps_filter_ffd_init_0_0->taps; n__ntaps_filter_ffd_init_0_0++) {
		...
		// forec:iteration:for1_15:bound:407:407
	}
...
float ntaps_filter_ffd(ntaps_filter_conf__global_0_0 *conf__ntaps_filter_ffd_0_0, const int input_size__ntaps_filter_ffd_0_0, const float input_values__ntaps_filter_ffd_0_0[]) {
	...
	for (i__ntaps_filter_ffd_0_0 = 0; i__ntaps_filter_ffd_0_0 < conf__ntaps_filter_ffd_0_0->decimation; i__ntaps_filter_ffd_0_0++) {
		...
		// forec:iteration:for1_16:bound:1:8
	}
	...
	for (i__ntaps_filter_ffd_0_0 = 0; i__ntaps_filter_ffd_0_0 < conf__ntaps_filter_ffd_0_0->taps; i__ntaps_filter_ffd_0_0++) {
		...
		// forec:iteration:for1_17:bound:407:407
	}
