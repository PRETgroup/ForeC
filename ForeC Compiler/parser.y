...
struct_or_union_specifier
	...
	| struct_or_union IDENTIFIER									{ $$ = new forec::ast::StructUnionSpecifier(*$1, *(new forec::ast::PrimaryExpression(*$2, @2.begin.line, "identifier")), "declaration"); }  // Could is a usage when followed by a declarator!
	;
