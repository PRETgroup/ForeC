...
#line 119 "parser.tab.h" // lalr1.cc:372
...
#line 12 "parser.y" // lalr1.cc:372
namespace forec { namespace loader {
#line 190 "parser.tab.h" // lalr1.cc:372
  ...
  public:
    ...
    union semantic_type
    {
    #line 93 "parser.y" // lalr1.cc:372

	forec::ast::Node *node;
	forec::ast::NodeList *nodeList;
	std::string *str;

#line 210 "parser.tab.h" // lalr1.cc:372
    };
#else
    ...
    Parser (forec::loader::Scanner &scanner_yyarg, forec::ast::Node &rootNode_yyarg);
    virtual ~Parser ();
  ...
  private:
    ...
    {
      yyeof_ = 0,
      yylast_ = 2330,     ///< Last index in yytable_.
    ...
    // User arguments.
    forec::loader::Scanner &scanner;
    forec::ast::Node &rootNode;
  };


#line 12 "parser.y" // lalr1.cc:372
} } // forec::loader
#line 620 "parser.tab.h" // lalr1.cc:372
