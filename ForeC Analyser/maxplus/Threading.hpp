#ifndef FOREC_MAXPLUS_THREADING_HPP
#define FOREC_MAXPLUS_THREADING_HPP
/*
 *  Threading.hpp
 *  
 *
	...
	namespace maxplus {
		class Threading {
			...
			public:
				...
				Threading(Threading &thread, const bool isAlternate);
...
#endif // FOREC_MAXPLUS_THREADING_HPP
